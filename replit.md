...
**Current Version: v3.17.20** - **Customer App V3 Header Update**: Updated header to match original Customer App design with compact yellow banner, proper width alignment with promotional image, and cropped hero image to remove duplicate yellow section.
