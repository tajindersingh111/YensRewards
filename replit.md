...
**Current Version: v3.17.38** - **Security Fix**: Moved "First Time Admin Setup" from public login page to secured Settings page (Security tab) to prevent unauthorized user creation now that app is embedded in YensThai.com.
