...
**Current Version: v3.17.10** - **Template Preview Fix**: Improved message template cards to show "(No name)" for unnamed templates, "📧 HTML Email" badge for visual editor templates, and "(No content)" for empty templates.
