...
export default function PointsCard({ points, tier, nextTierPoints }: PointsCardProps) {
  ...
  return (
    <Card className="p-8 bg-primary text-primary-foreground rounded-2xl" data-testid="points-card">
      <div className="flex flex-col items-center gap-3">
        ...
        <div className="text-center">
          <p className="text-xl font-medium opacity-90 mb-2">Your Points</p>
