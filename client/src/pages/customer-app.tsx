  ...
  return (
    <div className="h-screen bg-background flex flex-col overflow-hidden">
      ...
      <header className="bg-primary text-primary-foreground py-3 px-4 sticky top-0 z-50 flex-shrink-0">
        <div className="mx-auto w-full px-4 flex items-center justify-between" style={{maxWidth: "min(100vw, 420px)"}}>
          <Button 
            variant="ghost" 
            size="icon" 
            onClick={() => setLocation("/")}
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-xs opacity-70" data-testid="text-version">
                v87 | {typeof window !== 'undefined' ? Math.round(parseFloat(getComputedStyle(document.documentElement).fontSize)) : '?'}px | VW:{typeof window !== 'undefined' ? window.innerWidth : '?'}
              </span>
            </div>
          </div>
      ...
      <main className="flex-1 overflow-y-auto pb-24">
        <div className="mx-auto w-full px-4" style={{maxWidth: "min(100vw, 420px)"}}>
